...
![Overall pipeline](man/figures/Hub meeting - HuMMuS.png)
## Useful ressources
...
![hummus object schema](man/figures/hummus object description.png)
...
You can also directly import an example multilayer completed with : `data(chen_subset_hummus)`. This object corresponds to a multilayer from chen_dataset_subset completed. You can then go to the part 3, replacing `hummus` by `chen_subset_hummus` in each step.
